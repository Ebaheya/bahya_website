      ...
      builder: (context, child) {
        return Theme(
          data: Theme.of(context).copyWith(
            ...
            timePickerTheme: TimePickerThemeData(
              ...
              helpTextStyle: TextStyle(
                ...
                fontSize: responsiveSize(context, 0.035, min: 13, max: 18),
              ...
              hourMinuteTextStyle: TextStyle(
                fontFamily: 'ArabicCustomFont',
                fontSize: responsiveSize(context, 0.09, min: 30, max: 54),
                fontWeight: FontWeight.bold,
              ),
          ...
          child: MediaQuery(
            data: MediaQuery.of(
              context,
            ).copyWith(textScaler: TextScaler.linear(width < 380 ? 0.92 : 1)),
            child: child!,
          ),
        );
      },
